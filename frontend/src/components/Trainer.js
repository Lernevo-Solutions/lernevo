...
export function TrainerRolesPage() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      console.error("Failed to load trainer roles data", error);
  ...
  const updateMemberInState = (updatedMember) => {
    setMembers((prev) =>
      prev.map((member) => (member.id === updatedMember.id ? { ...member, ...updatedMember } : member))
    );
  };
  ...
  const exportCsv = () => {
    ...
    link.href = url;
    link.download = "trainer-roles-members.csv";
    ...
    <div style={styles.page}>
      ...
      <div style={styles.shell}>
        <div style={styles.hero}>
          <div>
            <div style={styles.kicker}>Trainer only</div>
            <h1 style={styles.title}>Trainer Access</h1>
            <p style={styles.subtitle}>
              Manage users and trainers within your scope. Super Admin and Admins do not appear in this module.
            </p>
          </div>
        ...
        <div style={styles.toolbar}>
          <div style={styles.searchWrap}>
            ...
            <input
              ...
              placeholder="Search by ID, email, name, role, or status"
          ...
          <div style={styles.filterWrap}>
            <div style={styles.filterChip}>
              ...
              <select
                ...
                style={styles.select}
              >
                {TRAINER_ROLE_FILTER_OPTIONS.map((option) => (
        ...
        <div style={styles.tableCard}>
          {loading ? (
            <div style={styles.emptyState}>Loading trainer access data...</div>
      ...
      {inviteOpen && (
        <ModalFrame
          title="Invite Member"
          subtitle="Trainer controls only"
          ...
          <form onSubmit={handleInviteSubmit} style={styles.modalBody}>
            ...
            <label style={styles.field}>
              ...
              <select
                ...
                style={styles.input}
              >
                {TRAINER_ROLE_OPTIONS.map((option) => (
...
function ModalFrame({ title, subtitle = "Trainer controls only", children, onClose }) {
  return (
...
const styles = {
  page: {
    ...
    position: "relative",
    overflow: "hidden",
    padding: "80px 16px 56px", // Increased top padding from 32px to 80px to clear the navbar
    color: "#0f172a",
  },
  glowA: {
    position: "absolute",
  ...
  shell: {
    ...
    zIndex: 1,
    maxWidth: "1440px",
    margin: "24px auto 0", // Added top margin for additional clearance
    display: "grid",
    gap: "20px",
  },
  hero: {
  ...
  modalHeader: {
    ...
    gap: "16px",
    padding: "20px 24px",
    background: "linear-gradient(135deg, #111827 0%, #b45309 100%)",
    color: "#fff",
  },
  modalTitle: {
    fontSize: "22px",
...
export default TrainerRolesPage;