...
import api from "../api"; // Assuming your axios/fetch instance path

const ROLE_OPTIONS = [
  { value: "USER", label: "User 👤" },
  { value: "TRAINER", label: "Trainer 🏋️" },
...
function User() {
  ...
  // 🔥 Invite Submit Handler (Integrated from user1.js)
  const handleInviteSubmit = async (event) => {
    ...
    setSaving(true);
    try {
      // API call to backend roles invite endpoint
  ...
  const styles = {
    ...
    headerH1: { fontSize: "28px", marginBottom: "8px", margin: 0 },
    headerP: { opacity: 0.9, fontSize: "14px", margin: 0 },
    inviteBtn: {
      background: "#ffffff",
      color: "#667eea",
      border: "none",
  ...
  return (
    <div style={styles.container}>
      <div style={styles.header}>
        ...
        {/* 🔥 Invite Member Button added in Header */}
        <button
          type="button"
        ...
        <div style={styles.modalOverlay} onClick={() => setInviteOpen(false)}>
          <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
            <div style={styles.modalHeader}>
              <div><strong>Invite New Member</strong></div>
              <button
                type="button"
              ...
              <div style={styles.modalBody}>
                <div style={styles.field}>
                  ...
                  <input
                    ...
                    placeholder="Enter email (e.g. member@gmail.com)"
                    required
                  />
                </div>
                <div style={styles.field}>
        ...
        <div style={styles.modalOverlay} onClick={closeEditModal}>
          <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
            <div style={styles.modalHeader}>
              ...
              <button type="button" onClick={closeEditModal} style={{ background: "transparent", border: "none", color: "#fff", fontSize: "20px", cursor: "pointer" }}>×</button>
            </div>
